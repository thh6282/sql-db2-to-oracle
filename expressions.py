...
class RegexpExtract2(Func):
    arg_types = {
        "this": True,
        "expression": False,
        "position": False,
        "collation": False,
        "is_regexp_extract": False
    }
    _sql_names = ["REGEXP_EXTRACT", "REGEXP_SUBSTR"]
    

# class Left(Func):
#     arg_types = {"this": True, "expression": False, "is_left": False}
#     _sql_names = ["LEFT", "LEFTSTR"]
    
# class Right(Func):
#     arg_types = {"this": True, "expression": False, "is_right": False}
#     _sql_names = ["RIGHT", "RIGHTSTR"]
...
class Substring(Func):
    _sql_names = ["SUBSTRING", "SUBSTR", "LEFT", "RIGHT"]
