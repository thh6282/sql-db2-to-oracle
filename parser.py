...
def build_regexp_extract(args: t.List, is_regexp_extract: t.Optional[bool] = None) -> exp.RegexpExtract2:
    return exp.RegexpExtract2(this=seq_get(args, 0), expression=seq_get(args, 1), is_regexp_extract= is_regexp_extract)
...
class Parser(metaclass=_Parser):
    ...
    def parse(
        ...
        """
        parmethod = self.__class__._parse_statement
        return self._parse(
